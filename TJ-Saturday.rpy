...
"I grab the back of TJ shirt and at the same time I see Carl's hoof disappear between rocks, then he falls back."
hide Carl with dissolve
play sound "bonebreak.ogg"
"And then there's a sound like a thick branch snapping in two, cutting through the air like a gunshot."
...
m "\"Who are you?\""
"The rustling leaves again, and I realize that while this might be Syndey, it's something MORE than Sydney."
...
scene bg black with slow_dissolve
"Five years later..."
scene bg flint with slow_dissolve
play loop "highway.ogg" fadein 3.0
